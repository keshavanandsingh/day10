...
public class AddressBookUC11 
{
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("1. Add a person details in existing address book");
			System.out.println("2. Edit a person details in existing address book");
			System.out.println("3. Delete a person details in existing address book");
			System.out.println("4. Show all contacts in existing address book");
			...
			case 1:show_all_address_books_name();
				   System.out.println("type the name of existing address book to add person details");
			...
			case 2:show_all_address_books_name();
			       System.out.println("type the name of existing address book to edit person details");
			...
			case 4:show_all_address_books_name();
		           ...
		           break;
			case 5:System.out.println("type name of address book to be created");
				   String name=s.next();
				   AddressBook addressbook=new AddressBook(name);
				   AddressBook.hm.put(name,addressbook);
				   System.out.println("Address Book created successfully");
				   break;
			case 6:System.out.println("type the city name");
				   String city=s.next();
				   search_by_city_name(city);
				   break;
			case 7:System.out.println("type the state name");
			       String state=s.next();
			       search_by_state_name(state);
			       break;
			case 8:System.out.println("type city name");
				   System.out.println(citytocontact.get(s.next()).size());
				   break;
			case 9:System.out.println("type state name");
				   System.out.println(statetocontact.get(s.next()).size());
				   break;
			case 10:show_all_address_books_name();
				    System.out.println("type address book");
